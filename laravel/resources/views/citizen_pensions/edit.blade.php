...
@section('title', 'Edit Pension Assignment - OneID-Pension Portal')
...
<div class="container-fluid px-0">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Update enrollment #{{ $citizenPension->enrollment_number }}</p>
        </div>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center gap-2">
            ...
            <span style="font-size: 1rem;">Edit Assignment Form</span>
        </div>
        <div class="card-body">
            <form action="{{ route('citizen-pensions.update', $citizenPension) }}" method="POST">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('citizen_id') is-invalid @enderror" id="citizen_id" name="citizen_id" required>
                            @foreach($citizens as $citizen)
                                <option value="{{ $citizen->id }}" @selected(old('citizen_id', $citizenPension->citizen_id) == $citizen->id)>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('pension_scheme_id') is-invalid @enderror" id="pension_scheme_id" name="pension_scheme_id" required>
                            @foreach($schemes as $scheme)
                                <option value="{{ $scheme->id }}" @selected(old('pension_scheme_id', $citizenPension->pension_scheme_id) == $scheme->id)>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('enrollment_number') is-invalid @enderror"
                               id="enrollment_number" name="enrollment_number" value="{{ old('enrollment_number', $citizenPension->enrollment_number) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('pension_start_date') is-invalid @enderror"
                               id="pension_start_date" name="pension_start_date" value="{{ old('pension_start_date', $citizenPension->pension_start_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select @error('pension_status') is-invalid @enderror" id="pension_status" name="pension_status" required>
                            <option value="Pending" @selected(old('pension_status', $citizenPension->pension_status) === 'Pending')>Pending</option>
                            <option value="Active" @selected(old('pension_status', $citizenPension->pension_status) === 'Active')>Active</option>
                            <option value="Suspended" @selected(old('pension_status', $citizenPension->pension_status) === 'Suspended')>Suspended</option>
                            <option value="Completed" @selected(old('pension_status', $citizenPension->pension_status) === 'Completed')>Completed</option>
                        </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" class="form-control @error('monthly_benefit_amount') is-invalid @enderror"
                           id="monthly_benefit_amount" name="monthly_benefit_amount" value="{{ old('monthly_benefit_amount', $citizenPension->monthly_benefit_amount) }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('notes') is-invalid @enderror"
                              id="notes" name="notes" rows="3">{{ old('notes', $citizenPension->notes) }}</textarea>
