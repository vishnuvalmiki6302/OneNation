...
@section('title', 'Edit Citizen - ' . $citizen->full_name)
...
<div class="container-fluid px-0">
    <div class="page-header">
        <div>
            <h1>Edit Citizen</h1>
            <p class="page-subtitle">Update details for {{ $citizen->full_name }}</p>
        </div>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center gap-2">
            ...
            <span style="font-size: 1rem;">Edit Citizen Record</span>
        </div>
        <div class="card-body">
            <form action="{{ route('citizens.update', $citizen) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('full_name') is-invalid @enderror"
                               id="full_name" name="full_name" value="{{ old('full_name', $citizen->full_name) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('aadhaar_number') is-invalid @enderror"
                               id="aadhaar_number" name="aadhaar_number" value="{{ old('aadhaar_number', $citizen->aadhaar_number) }}"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('mobile_number') is-invalid @enderror"
                               id="mobile_number" name="mobile_number" value="{{ old('mobile_number', $citizen->mobile_number) }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control @error('email_address') is-invalid @enderror"
                               id="email_address" name="email_address" value="{{ old('email_address', $citizen->email_address) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror"
                               id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $citizen->date_of_birth->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select @error('pension_status') is-invalid @enderror" id="pension_status" name="pension_status" required>
                            <option value="None" @selected(old('pension_status', $citizen->pension_status) === 'None')>None</option>
                            <option value="Pending" @selected(old('pension_status', $citizen->pension_status) === 'Pending')>Pending</option>
                            <option value="Active" @selected(old('pension_status', $citizen->pension_status) === 'Active')>Active</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('state') is-invalid @enderror" id="state" name="state" required>
                            @foreach($states as $state)
                                <option value="{{ $state }}" @selected(old('state', $citizen->state) === $state)>{{ $state }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('district') is-invalid @enderror"
                               id="district" name="district" value="{{ old('district', $citizen->district) }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('full_address') is-invalid @enderror"
                              id="full_address" name="full_address" rows="3" required>{{ old('full_address', $citizen->full_address) }}</textarea>
