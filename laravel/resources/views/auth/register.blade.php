...
<head>
    ...
    <title>Create Account - OneID-Pension Portal</title>
    ...
    <style>
        ...
        /* The curved colored pane (now on the right) */
        .login-info {
            flex: 0 0 45%;
...
<body>
    ...
    <div class="login-wrapper">
        ...
        <!-- Right Side: Colored Pane with curved left edge -->
        <div class="login-info">
            <h1 class="main-title">Welcome Back!</h1>
            <p class="main-desc">To keep connected with us please log in with your personal info.</p>
